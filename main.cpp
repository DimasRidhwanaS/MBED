...
//    hehe.Mode = GPIOcon_MODE_OUTPUT_PP;
...
//        xSemaphorePulseData.release();
        ...
        locomotionMotorFL.setpwm(0.21);
        locomotionMotorFR.setpwm(0.21);
        locomotionMotorBL.setpwm(0.21);
        locomotionMotorBR.setpwm(0.21);     
